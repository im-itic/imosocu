<div class="w-80px mt-3 mb-3 ml-3">
    <img src="{{asset('reqs/img/basic/logo.png')}}" alt="">
</div>
<div class="relative">
    ...
    <div class="user-panel p-3 light mb-2">
        <div>
            <div class="float-left image">
                <img class="user_avatar" src="{{asset('reqs/img/dummy/u2.png')}}" alt="User Image">
            </div>
...
<ul class="sidebar-menu">
    <li class="header"><strong>ADMIN NAVIGATION</strong></li>
